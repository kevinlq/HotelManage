...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CustomerWindget_t, stringdata0) + ofs \
...
void CustomerWindget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CustomerWindget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject CustomerWindget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_CustomerWindget.data,
    qt_meta_data_CustomerWindget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CustomerWindget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CustomerWindget.stringdata0))
